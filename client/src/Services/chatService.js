...
export function useGetGlobalMessages() {
    ...
    const getGlobalMessages = () => {
        return fetch(
            `${process.env.REACT_APP_API_URL}/api/messages/globalMessages`,
            requestOptions
        )
            .then(handleResponse)
            .catch(() =>
...
export function useGetConversations() {
    ...
    const getConversations = () => {
        return fetch(
            `${process.env.REACT_APP_API_URL}/api/messages/conversationList`,
            requestOptions
        )
            .then(handleResponse)
            .catch(() =>
...
export function useGetConversationMessages() {
    ...
    const getConversationMessages = id => {
        return fetch(
            ...
            }/api/messages/conversationByUser/query?userId=${id}`,
            requestOptions
        )
            .then(handleResponse)
            .catch(() =>
...
export function useSendConversationMessage() {
    ...
    const sendConversationMessage = (id, body) => {
        ...
        return fetch(
            `${process.env.REACT_APP_API_URL}/api/messages/personal`,
            requestOptions
        )
            .then(handleResponse)
            .catch(err => {
